    ...
    <div className="flex flex-wrap flex-col gap-2">
      <table className="bordered_table table-auto">
        ...
        <tr>
          ...
          <td><a :href="'mailto:' + serviceStore.service.contact_email">{{ serviceStore.service.contact_email }}</a>
          </td>
        </tr>
        <tr>
          <th className="w-1/4">Contact Number</th>
          <td><a :href="'phone:' + serviceStore.service.contact_number">{{ serviceStore.service.contact_number }}</a>
          </td>
        </tr>
        </tbody>
      </table>
